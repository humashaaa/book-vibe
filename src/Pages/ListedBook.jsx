...
const ListedBook = () => {
    ...
    return (
       <div>
        <div className="bg-slate-100 mt-20 min-h-10 p-6 text-center font-bold text-2xl">
            <h1>Books</h1>
        </div>
        {/* short by button */}
        {/* tabs */}
        <div className="flex items-center -mx-4 mt-10 ml-9 overflow-x-auto overflow-y-hidden justify-start  flex-nowrap dark:bg-gray-100 dark:text-gray-800">
